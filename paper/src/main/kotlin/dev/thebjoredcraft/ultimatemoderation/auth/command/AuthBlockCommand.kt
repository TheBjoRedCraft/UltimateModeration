...
class AuthBlockCommand(commandName: String): CommandAPICommand(commandName) {
    init {
        ...
        executesPlayer(PlayerCommandExecutor { player, args ->
            ...
            if(success) {
                UltimateModerationPaper.send(MessageBuilder().primary("Du hast den Account ").info(username).error(" blockiert."), player)
            } else {
